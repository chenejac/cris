    ...
    <html>
      <head>
        ...
        <style type="text/css">
          <xsl:comment>
            ADDRESS {
				FONT-SIZE: medium; FONT-FAMILY: Geneva, Verdana, Helvetica, Arial, sans-serif
			}
			BODY {
				FONT-SIZE: medium; COLOR: #000000; FONT-FAMILY: Arial, Helvetica, Geneva, Verdana, sans-serif
			}
			BUTTON {
				CURSOR: auto
			}
			...
			TD {
				FONT-SIZE: medium; MARGIN-LEFT: 0px; FONT-FAMILY: Arial, Helvetica, Geneva, Verdana, sans-serif
			}
			TEXTAREA {
				CURSOR: text; COLOR: #000000; BACKGROUND-COLOR: #ffffff
			}
			TH {
				FONT-WEIGHT: bold; FONT-SIZE: medium; MARGIN-LEFT: 0px; FONT-FAMILY: Arial, Helvetica, Geneva, Verdana, sans-serif; TEXT-ALIGN: center
			}
			A.footer:link {
      ...
      <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table width="100%" border="0" cellpadding="0" cellspacing="20">
          <tr valign="top">
            <td><a href="./interoperability/identify.html">Identify</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="./interoperability/getRecord.html">GetRecord</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="./interoperability/listIdentifiers.html">ListIdentifiers</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text>(<a href="./interoperability/listIdentifiersResumption.html">Resumption</a>)<xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="./interoperability/listMetadataFormats.html">ListMetadataFormats</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="./interoperability/listRecords.html">ListRecords</a><xsl:text disable-output-escaping="yes">&#160;</xsl:text>(<a href="./interoperability/listRecordsResumption.html">Resumption</a>)<xsl:text disable-output-escaping="yes">&#160;</xsl:text><span class="divider">|</span><xsl:text disable-output-escaping="yes">&#160;</xsl:text><a href="./interoperability/listSets.html">ListSets</a></td>
          </tr>
          <tr valign="top">
            <td bgcolor="#cccccc">
          ...
          <tr valign="top">
            <td><address><a href="mailto:cris@uns.ac.rs">CRISUNS team</a></address></td>
          </tr>
        </table>
      </body>
    </html>
...
-->
 ...
 <xsl:template match="marc:leader">
    <tr valign="top">
     	<td width="150"><strong>LDR</strong></td>
      	<td><xsl:value-of select="."/></td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="marc:controlfield">
    <tr valign="top">
     	<td width="150"><strong>CF&#160;<xsl:value-of select="@tag"/></strong></td>
        <td><xsl:value-of select="."/></td>
    </tr>
  </xsl:template>
   ...
   <xsl:template match="marc:datafield">
    <tr valign="top">
     	<td width="150"><strong>DF&#160;<xsl:value-of select="@tag"/>(<xsl:value-of select="@ind1"/><xsl:value-of select="@ind2"/>)</strong></td>
        <td>
        	<table width="100%" border="0" cellspacing="4" cellpadding="0">	
  ...
  <xsl:template match="marc:subfield">
    <tr valign="top">
     	<td width="150"><strong>SF&#160;<xsl:value-of select="@code"/></strong></td>
        <td><xsl:value-of select="."/></td>
    </tr>
  </xsl:template>
