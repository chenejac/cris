 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_PlaniranjeRegulisanjeIBezbednostSaobracaja extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_PlaniranjeRegulisanjeIBezbednostSaobracaja(){
		super();
		comissionID = 168;
		appointmentBoard = "SV-TT-FTN-PRiBS";
