...
public class MNOMaterijaliIHemijskeTehnologije extends MNO{
	...
	private MNOMaterijaliIHemijskeTehnologije(){
		...
		importFromXLS(FileStorage.storageRoot + "/import/mnoMaterijaliIHemijskaTehnologija2020.xlsx", special2020);
		...
		importFromXLS(FileStorage.storageRoot + "/import/mno_2023_u_oblasti_materijala_i_hemijskih_tehnologija.xlsx", special2023);
