...
public class MNORacunarskeNauke extends MNO{
	...
	private MNORacunarskeNauke() {
		...
		importFromXLS(FileStorage.storageRoot + "/import/mno_2022_za_racunarske_nauke.xlsx", special2022);
		this.specialJournalsAllYears.put(2022, special2022);

		special2023 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mno_2023_za_racunarske_nauke.xlsx", special2023);
