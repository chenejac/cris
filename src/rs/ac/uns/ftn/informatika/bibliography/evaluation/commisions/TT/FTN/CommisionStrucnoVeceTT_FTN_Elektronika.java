 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_Elektronika extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_Elektronika(){
		super();
		comissionID = 166;
		appointmentBoard = "SV-TT-FTN-E";
