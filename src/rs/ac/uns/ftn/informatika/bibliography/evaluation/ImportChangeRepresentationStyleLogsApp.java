 ...
 *
 */
public class ImportChangeRepresentationStyleLogsApp {
...
//				+ "/" + schema + connectionParameters, username, password);
		...
		ImportChangeRepresentationStyleLogsTask task = new ImportChangeRepresentationStyleLogsTask(conn, new FileInputStream ("E:/cris/logs/20170823/crisRepresentationStyleLog.log"));
		if(task.execute())
