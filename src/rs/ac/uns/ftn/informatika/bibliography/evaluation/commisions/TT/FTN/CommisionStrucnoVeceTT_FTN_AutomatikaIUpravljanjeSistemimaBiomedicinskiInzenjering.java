...
public class CommisionStrucnoVeceTT_FTN_AutomatikaIUpravljanjeSistemimaBiomedicinskiInzenjering extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_AutomatikaIUpravljanjeSistemimaBiomedicinskiInzenjering(){
		super();
		comissionID = 151;
		appointmentBoard = "SV-TT-FTN-AiUS-BI";
