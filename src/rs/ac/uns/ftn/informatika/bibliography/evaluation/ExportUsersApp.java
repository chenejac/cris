...
public class ExportUsersApp {
	...
	public static void main(String[] args) throws Exception {
		...
		ExportUsersTask task = new ExportUsersTask(conn, new PrintWriter(new File("D:/users.csv"), "UTF8"));// new PrintWriter(System.out, true));
		if(task.execute())
			System.out.println("Export of users done!");
		else {
			System.out.println("Export of users failed!");
		}
	}
