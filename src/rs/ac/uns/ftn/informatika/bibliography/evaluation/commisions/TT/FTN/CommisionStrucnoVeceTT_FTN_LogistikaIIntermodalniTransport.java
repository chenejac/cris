 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_LogistikaIIntermodalniTransport extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_LogistikaIIntermodalniTransport(){
		super();
		comissionID = 159;
		appointmentBoard = "SV-TT-FTN-LiIT";
