 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_UmetnostPrimenjenaNaArhitekturuTehnikuIDizajn extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_UmetnostPrimenjenaNaArhitekturuTehnikuIDizajn(){
		super();
		comissionID = 165;
		appointmentBoard = "SV-TT-FTN-UPnATiD";
