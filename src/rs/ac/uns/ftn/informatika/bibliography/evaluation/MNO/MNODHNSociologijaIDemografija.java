...
public class MNODHNSociologijaIDemografija extends MNO{
	...
	private MNODHNSociologijaIDemografija() {
		...
		importFromXLS(FileStorage.storageRoot + "/import/mno_2022_za_sociologiju_i_demografiju.xlsx", special2022);
		this.specialJournalsAllYears.put(2022, special2022);

		special2023 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mno_2023_za_sociologiju_i_demografiju.xlsx", special2023);
