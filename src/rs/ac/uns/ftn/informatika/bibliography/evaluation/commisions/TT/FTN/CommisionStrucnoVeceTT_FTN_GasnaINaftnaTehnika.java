 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_GasnaINaftnaTehnika extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_GasnaINaftnaTehnika(){
		super();
		comissionID = 172;
		appointmentBoard = "SV-TT-FTN-GiNT";
