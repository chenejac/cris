...
public class MNOHemija extends MNO{
	...
	private MNOHemija() {
		...
		importFromXLS(FileStorage.storageRoot + "/import/mno_2022_za_hemiju.xlsx", special2022);
		this.specialJournalsAllYears.put(2022, special2022);

		special2023 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mno_2023_za_hemiju.xlsx", special2023);
