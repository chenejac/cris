...
public class MNOSaobracajUrbanizamIGradevinarstvo extends MNO{
	...
	private MNOSaobracajUrbanizamIGradevinarstvo() {
		...
		importFromXLS(FileStorage.storageRoot + "/import/mnoSaobracajUrbanizamIGradjevinarstvo2019.xlsx", special2019);
		this.specialJournalsAllYears.put(2019, special2019);

		special2020 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mnoSaobracajUrbanizamIGradjevinarstvo2020.xlsx", special2020);
