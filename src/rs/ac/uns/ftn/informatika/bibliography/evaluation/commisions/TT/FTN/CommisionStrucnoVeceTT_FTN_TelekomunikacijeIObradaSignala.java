 ...
 *
 */
public class CommisionStrucnoVeceTT_FTN_TelekomunikacijeIObradaSignala extends CommisionStrucnoVece {

	public CommisionStrucnoVeceTT_FTN_TelekomunikacijeIObradaSignala(){
		super();
		comissionID = 160;
		appointmentBoard = "SV-TT-FTN-TiOS";
