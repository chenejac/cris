...
public class MNOBiologija extends MNO{
	...
	private MNOBiologija() {
		...
		importFromXLS(FileStorage.storageRoot + "/import/mnoBiologija2021.xlsx", special2021);
		this.specialJournalsAllYears.put(2021, special2021);

		special2022 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mno_2022_za_biologiju.xlsx", special2022);
		this.specialJournalsAllYears.put(2022, special2022);

		special2023 = new HashMap<String, String>();
		importFromXLS(FileStorage.storageRoot + "/import/mno_2023_za_biologiju.xlsx", special2023);
