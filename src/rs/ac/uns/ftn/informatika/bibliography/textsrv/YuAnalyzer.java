 ...
 * 
 */
public class YuAnalyzer extends Analyzer {

	private Set<String> yuStopSet;
	private static final String[] YU_STOP_WORDS = {
		"i", "ili", "a", "ali", "pa",
		"biti", "ne", 
	...
	public YuAnalyzer() {
		super();
		yuStopSet = StopFilter.makeStopSet(YU_STOP_WORDS);
	}
					...
					new CroSerTranslateFilter(
						new SnowballFilter(
							new StopFilter(
								new LatCyrFilter(
									new LowerCaseFilter(
											new WhitespaceTokenizer(reader))), yuStopSet), new SerbianStemmer())), true);
	}
}
