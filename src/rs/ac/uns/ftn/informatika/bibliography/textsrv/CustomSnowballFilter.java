 ...
 */
public class CustomSnowballFilter extends TokenFilter {

  private SnowballProgram stemmer;

  public CustomSnowballFilter(TokenStream input, SnowballProgram stemmer) {
    super(input);
   ...
   */
  public CustomSnowballFilter(TokenStream in, String name) {
    super(in);
    try {      
...
//    if (!originalTerm.equals(finalTerm))
      nextToken.setTermBuffer(finalTerm + "[" + originalTerm + "]");
    return nextToken;
  }
}
