...
public class PaperMonographDTO extends PublicationDTO {
...
//	private String uri = "";
	 ...
	 *            Control number
	 */
	public PaperMonographDTO(String controlNumber) {
		super(controlNumber);
		otherAuthors = new ArrayList<AuthorDTO>();
		mainAuthor = new AuthorDTO();
		monograph = new MonographDTO();
	...
	* @param controlNumber
	 ...
	 * @param doi
	 */
	public PaperMonographDTO(String controlNumber, MultilingualContentDTO title,  
			...
			MonographDTO monograph, AuthorDTO mainAuthor, List<AuthorDTO> otherAuthors, MultilingualContentDTO note,  
...
//	}
	...
	public String toString() {
		if(notLoaded)
			...
			if ((monograph != null) && (monograph.getControlNumber() != null))
				retVal.append(monograph.toString());
			else
				retVal.append("Monograph");
	...
	public String getPublicationYear() {
		...
		if(monograph!=null)
			return monograph.getPublicationYear();
		else 
			return null;
	}
	...
	public String getHTMLRepresentation() {
		if((notLoaded) && (locale.getLanguage().equals("sr"))){
			...
			StringBuffer retVal = new StringBuffer();
			retVal.append("<u>" + fm.getMessageFromResourceBundle("records.bibliography.paperMonograph") + "</u><br/>");
			if ((mainAuthor != null) && (mainAuthor.getControlNumber() != null))
			...
			if ((monograph != null) && (monograph.getControlNumber() != null))
				retVal.append(fm.getMessageFromResourceBundle("records.bibliography.monograph") + ": " + monograph.toString() + "<br/>");
			if ((startPage != null) && (endPage != null))
	...
	public String getKnrXML(String indent, ResultMeasureDTO resultMeasure) {
		if(notLoaded)
			record.loadFromDatabase();
		StringBuffer retVal = new StringBuffer();
		retVal.append(indent + "<paperMonograph>\n");
		...
		if(monograph != null)
			retVal.append(monograph.getKnrXML(indent + "\t", null));
