...
public class ScienceAreaDTO extends ClassDTO {
	 ...
	 * @param description
	 */
	public ScienceAreaDTO(String schemeId, String classId, MultilingualContentDTO term, List<MultilingualContentDTO> termTranslations,
