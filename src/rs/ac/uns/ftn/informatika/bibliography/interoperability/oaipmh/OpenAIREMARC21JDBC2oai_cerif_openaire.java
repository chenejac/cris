 ...
 */
public class OpenAIREMARC21JDBC2oai_cerif_openaire extends CRISUNSCrosswalk {
     ...
     */
    public OpenAIREMARC21JDBC2oai_cerif_openaire(Properties properties) {
    	...
    	serializer = new OpenAIRECRISXMLSerializer();
    }   
