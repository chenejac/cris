...
import rs.ac.uns.ftn.informatika.bibliography.interoperability.serializers.NDLTDETDMSXMLSerializer;
import rs.ac.uns.ftn.informatika.bibliography.marc21.cerifentities.Record;

/**
 * Convert native "item" to oai_etdms. 
 */
public class NDLTDMARC21JDBC2oai_etdms extends CRISUNSCrosswalk {
     ...
     */
    public NDLTDMARC21JDBC2oai_etdms(Properties properties) {
    	super(properties, "http://www.ndltd.org/standards/metadata/etdms/1.1/ http://cris.uns.ac.rs/etdms/1.1/etdms11.xsd");
    	identifierLabel = properties.getProperty("JDBCRecordFactory.identifierLabel");
    	serializer = new NDLTDETDMSXMLSerializer();
	...
	public boolean isAvailableFor(Object nativeItem) {
		...
		if(record != null && record.getDto() instanceof StudyFinalDocumentDTO){
