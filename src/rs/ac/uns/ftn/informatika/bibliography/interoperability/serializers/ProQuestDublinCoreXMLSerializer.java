 ...
 * 
 */
public class ProQuestDublinCoreXMLSerializer extends AbstractDublinCoreXMLSerializer {

	/**
	 */
	public ProQuestDublinCoreXMLSerializer() {
		super(Arrays.asList("en"), "ProQuest");
	}
