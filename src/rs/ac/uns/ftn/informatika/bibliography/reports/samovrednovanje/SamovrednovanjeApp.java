 ...
 */
	...
	public static void setIdsForOrganisations(Connection conn1){
	 idsPMF = obtainIdsForOrganisation("pmf", "2011-01-01 00:00:00",conn1);
	 
	idsDMI = obtainIdsForOrganisation("dmi", "2011-01-01 00:00:00", conn1);
		idsDF = obtainIdsForOrganisation("df", "2011-01-01 00:00:00", conn1);
		idsDH = obtainIdsForOrganisation("dh", "2011-01-01 00:00:00", conn1);
		idsDB = obtainIdsForOrganisation("db", "2011-01-01 00:00:00", conn1);
		idsDG = obtainIdsForOrganisation("dg", "2011-01-01 00:00:00", conn1);		
	}
