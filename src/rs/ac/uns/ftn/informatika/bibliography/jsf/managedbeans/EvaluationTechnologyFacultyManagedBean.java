...
public class EvaluationTechnologyFacultyManagedBean extends CRUDManagedBean implements IPickJournalManagedBean{
	...
	public EvaluationTechnologyFacultyManagedBean() {
		super();
		init();	
...
//	        allCommissions.add(new SelectItem(null, facesMessages.getMessageFromResourceBundle("evaluation.mainPanel.yearCommissionSelection.commission.pleaseSelectCommission")));
	...
	protected String dispetcher(int condition) {
		String retVal = null;
		retVal = "evaluationTechnologyFacultyPage";
		return retVal;
	}
	...
	public String enterPage() {
		...
		return "evaluationTechnologyFacultyPage";
	}
