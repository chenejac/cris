...
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMBiologija;
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMFizika;
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMGeografija;
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMHemija;
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMInformatika;
import rs.ac.uns.ftn.informatika.bibliography.evaluation.commisions.CommisionStrucnoVecePMMatematika;
...
public class EvaluationStrucnoVecePMManagedBean extends CRUDManagedBean implements IPickJournalManagedBean{
	...
	public EvaluationStrucnoVecePMManagedBean() {
		super();
		init();	
	...
	public void init ()
	{
		...
		try {
	        ...
	        //STRUCNO VECE KOMISIJE od 51-100
	        
	        for (CommissionDTO com : commissionList){
	        	if(com.getCommissionId()>=51 && com.getCommissionId()<=100)
	...
	protected String dispetcher(int condition) {
		String retVal = null;
		retVal = "evaluationStrucnoVecePMPage";
		return retVal;
	}
	...
	public String enterPage() {
		...
		return "evaluationStrucnoVecePMPage";
	}
	...
	public void setCommissionRuleBook() {
		...
		if(commissionID!=null)
			pdfUrl = facesMessages.getMessageFromResourceBundle("evaluation.mainPanel.yearCommissionSelection.commission.rulebook.id"+51);
		else
			pdfUrl = null;
...
//		System.out.println(journalControlNUmber);
	...
	public void calculateExplainTable() {
		...
		if (commissionID >=51 && commissionID <=100){
