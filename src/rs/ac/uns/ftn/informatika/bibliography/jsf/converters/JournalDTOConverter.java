 ...
 */
public class JournalDTOConverter implements javax.faces.convert.Converter {
	 ...
	 *      UIComponent, String)
	 */
	public JournalDTO getAsObject(FacesContext context,
								  UIComponent component, String value) throws ConverterException {
		JournalDTO retVal = null;


		retVal = (JournalDTO)recordDAO.getDTO(value);
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		if(value != null)
			return ((JournalDTO)value).getControlNumber();
		else
			return null;
	}

	@SuppressWarnings("unused")
	private static Log log = LogFactory.getLog(JournalDTOConverter.class
			.getName());
