...
public class DcContexSet  extends ContextSetStrategy{
	...
	public Query parseRelation(String lucineIndex, String relation, CQLTermNode ctn, boolean spanqery) {
		String pattern = rbSearch.getString("search.DCContextSet.relationDCContextSet");
	...
	{
		String pattern = rbSearch.getString("search.DCContextSet.proxDCContextSet");
