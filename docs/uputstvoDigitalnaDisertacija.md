...
o	Тезе и дисертaције
•	Одабир Аутора
	Аутор
	Пример када у систему нема аутора
	Преглед и ажурирање података
o	Сви резултати (није урађено!)
o	Промоција (није урађено!) 
o	Промена лозинке (није урађено!)
- Унос података
- Основни подаци
o	Први део основних података
•	Додавање облика имена
•	Превод наслова
o	Ментори и чланови комисије
