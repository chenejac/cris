...
Кликом на ову икопницу [![image](../../images/import24.png)](../../uvoz/importPodataka.md) добија се страница за Импорт (увоз) података из Scopus-a. 
    
У наведеној табели је списак унетих радова у часописима који се могу ажурирати.   
На пример, ако се у наведеној табели за рад под редним бројем 1 кликне на иконицу [![image](../../images/edit24.png)](AzuriranjePodatakaOraduUcasopisu.md) онда се добија страница за ажурирање података том раду.  
